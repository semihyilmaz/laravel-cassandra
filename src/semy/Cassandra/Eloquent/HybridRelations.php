...
use semy\Cassandra\Relations\BelongsTo;
use semy\Cassandra\Relations\BelongsToMany;
use semy\Cassandra\Relations\HasMany;
use semy\Cassandra\Relations\HasOne;
use semy\Cassandra\Relations\MorphTo;
...
trait HybridRelations
{
    ...
    public function hasOne($related, $foreignKey = null, $localKey = null)
    {
        ...
        if (! is_subclass_of($related, 'semy\Cassandra\Eloquent\Model')) {
