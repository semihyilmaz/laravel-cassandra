...
namespace semy\Cassandra\Eloquent;

use Carbon\Carbon;
use DateTime;
use Illuminate\Database\Eloquent\Model as BaseModel;
use Illuminate\Database\Eloquent\Relations\Relation;
use semy\Cassandra\Query\Builder as QueryBuilder;
use semy\Cassandra\Relations\EmbedsMany;
use semy\Cassandra\Relations\EmbedsOne;
use semy\Cassandra\Relations\EmbedsOneOrMany;
...
abstract class Model extends BaseModel
{
     ...
     * @return \semy\Cassandra\Relations\EmbedsMany
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $relation
     * @return \semy\Cassandra\Relations\EmbedsOne
     */
     ...
     *
     * @param  \semy\Cassandra\Query\Builder $query
     * @return \semy\Cassandra\Eloquent\Builder|static
     */
